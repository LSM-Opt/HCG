...
```bash
git clone https://github.com/LSM-Opt/HCG.git
cd HCG/llm-compressor-npu
pip install -e .
```
...
### Supported Formats
* Activation Quantization: W8A8 (int8)
* Mixed Precision: W4A16, W8A16 (W4A4 and W4A16 support)
